...
function validaCampos(){
	...
	var errores='';
	var nErrores=0;
	if(tipo=="no elegido") errores+='('+(++nErrores)+') Debe elegir si es equipo de primaria, secundaria o adultos.\n';
	...
	if (tipo!='adultos'){//si es adultos no se tienen en cuenta esta valoracion
...
function lee(){
	...
	if(document.getElementById('adultos')&&document.getElementById('adultos').checked) tipo='adultos';
...
var generaPDF = function (imgData){//alert('entro');
	...
	doc.rect(10, 71, 5, 5, 'FD');
	doc.rect(10, 79, 5, 5, 'FD');
	...
	doc.text(18, 75, 'Equipo de Ed. Secundaria de Centro');
		doc.setFontSize(10);doc.text(88, 75,'(4 alumnos de Ed. Secundaria del mismo Centro Educativo)');
		doc.setFontSize(12); 
	doc.text(18, 83, 'Equipo de Ed. para Adultos de Centro');
		doc.setFontSize(10);doc.text(90, 83,'(4 alumnos de Ed. para Adultos del mismo Centro Educativo)');
		doc.setFontSize(12); 
	...
	if (document.getElementById('primaria').checked)
	{
		...
		if(document.getElementById('secundaria').checked){
			doc.setFontType("bold");
        	doc.text(11, 75, 'X');doc.setFontType("normal");

		}else{
			doc.setFontType("bold");
        	doc.text(11, 83, 'X');doc.setFontType("normal");
    ...
    /*var secuoAdultos='Secundaria';
	if(document.getElementById('adultos').checked) secuoAdultos='para Adultos';
	doc.text(18, 96, 'Equipo de Ed. '+secuoAdultos+' de Centro');
		doc.setFontSize(10);doc.text(93, 96,'(4 alumnos de Ed. '+secuoAdultos+' del mismo Centro Educativo)');
		doc.setFontSize(12); */
	...
	/*if (document.getElementById('secundaria').checked||document.getElementById('adultos').checked)
	{*/
	...
	doc.text(20, 252, 'Puede consultar el estado de la solicitud escaneando el codigo QR o visitando:');
