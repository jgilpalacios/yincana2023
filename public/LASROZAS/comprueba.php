...
if($resultado){
	if($estado==0){
		...
		echo '<body class="LESPERA">EL CTIF MADRID-OESTE HA RECIBIDO SU SOLICITUD PERO COMO YA SE HA LLEGADO<br>AL TOPE DE LOS EQUIPOS DE SU CENTRO, ESTE EQUIPO <b>ESTÁ EN LA LISTA DE ESPERA</b>';
	}else if($estado==4){
